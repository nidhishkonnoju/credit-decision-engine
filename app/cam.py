...
FEATURE_TO_5C: dict[str, str] = {
    ...
    "PL_Flag": "Capital",
    "max_unsec_exposure_inPct": "Capital",
    "HL_Flag": "Collateral",
    "GL_Flag": "Collateral",
    "Total_TL": "Capital",
...
FEATURE_TO_5C_RATIONALE: dict[str, str] = {
    ...
    "CC_Flag": "The presence of credit-card exposure identifies revolving debt burden that affects available capital and capacity to absorb a financial shock.",
    "PL_utilization": "Personal-loan utilization measures usage of an existing installment facility and informs Capital.",
    "PL_Flag": "The presence of a personal loan identifies existing debt exposure that affects net worth and capacity to absorb a financial shock.",
    "max_unsec_exposure_inPct": "The share of unsecured exposure measures debt burden without pledged assets and informs Capital because it affects net worth and shock absorption.",
    ...
    "CC_TL": "The number of credit-card lines measures revolving debt exposure and informs Capital because it affects available borrowing capacity and shock absorption.",
    ...
    "PL_TL": "Personal-loan lines measure existing installment debt and inform Capital because they affect net worth and capacity to absorb a financial shock.",
    "Secured_TL": "Secured-loan lines identify obligations backed by pledged assets and inform Collateral.",
    "Unsecured_TL": "Unsecured-loan lines measure debt exposure without pledged assets and inform Capital because they affect net worth and shock absorption.",
